...
//           milestones => `${milestones.name}: ${milestones.descriptions} - ${milestones.completed ? 'Completed' : 'Not Completed'}`
//         )
//       ]);
//     });

//     worksheet.columns = [
//       { header: 'ID', key: 'id', width: 40 }, // ID column width: 10
//       { header: 'Name', key: 'name', width: 25 }, // Name column width: 25
//       { header: 'Description', key: 'description', width: 40 }, // Description column width: 40
//       { header: 'Progress', key: 'progress', width: 15 }, // Progress column width: 15
//       { header: 'Priority', key: 'priority', width: 15 }, // Priority column width: 15
//       { header: 'Category', key: 'category', width: 20 }, // Category column width: 20
//       { header: 'Milestone 1 (20%)', key: 'milestones1', width: 50 },
//       { header: 'Milestone 2 (40%)', key: 'milestones2', width: 50 },
//       { header: 'Milestone 3 (60%)', key: 'milestones3', width: 50 }, // Milestones column width: 50
